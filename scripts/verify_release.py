...
Exit zero certifies the transition-channel information-capacity result for all
1/2 <= p < 1, never the operational coding theorem or the whole paper.
...
ENDPOINT = 'QIT.Transition.superactivation_main'
CURRENT_TARGET = 'CurrentProof'
ENDPOINT_MARKER = 'EXACT_ENDPOINT_WITH_ONLY_PARAMETER_CONDITIONS_PASS'
